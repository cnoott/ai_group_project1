...
class PDWorld:
    ...
    def print_current_state(self):  # for debugging
        ...
        print(self.current_matrix, ': Current matrix')
...
def play(world, agent, policy, max_steps):
    ...
    while step < max_steps:
        ...
        world.check_terminal_state()
        # time.sleep(0.1)
    print('Number of terminal states the agent reached:',
          world.terminal_states_reached)
