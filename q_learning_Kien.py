...
class GridWorld:
    ...
    def __init__(self):
        ...
        self.grid[self.P_location[0], self.P_location[1]] = 13
        self.grid[self.D_location[0], self.D_location[1]] = 13
    ...
    def __init__(self, environment, epsilon=0.05, alpha=0.1, gamma=1):
        ...
        for x in range(environment.height):  # Loop through all possible grid spaces, create sub-dictionary for each
            for y in range(environment.width):
                self.q_table[(x, y)] = {'N': 0, 'S': 0, 'W': 0,
                                        'E': 0}  # Populate sub-dictionary with zero values for possible moves
